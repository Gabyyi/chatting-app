...
<head>
    ...
    <script src="isb_messages.js" defer></script>
</head>
<body>
    ...
    <div class="content">
        <div class="chats">
            <ul>
                ...
                <li><a href="isb_chat.php">ISB</a></li>
        ...
        <div id="chat-container" class="chat-container">
            ...
            <div class="chat-input">
                <form action="isb_chat_input.php" method="post" id="messageForm">
