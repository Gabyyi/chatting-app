...
<head>
    ...
    <script src="etti_messages.js" defer></script>
</head>
<body>
    ...
    <div class="content">
        <div class="chats">
            <ul>
                ...
                <li><a href="etti_chat.php">ETTI</a></li>
        ...
        <div id="chat-container" class="chat-container">
            ...
            <div class="chat-input">
                <form action="etti_chat_input.php" method="post" id="messageForm">
