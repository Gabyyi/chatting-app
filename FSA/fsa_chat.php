...
<head>
    ...
    <script src="fsa_messages.js" defer></script>
</head>
<body>
    ...
    <div class="content">
        <div class="chats">
            <ul>
                ...
                <div class="open-chat">
                    <li><a href="fsa_chat.php">FSA</a></li>
                </div>    
        ...
        <div id="chat-container" class="chat-container">
            ...
            <div class="chat-input">
                <form action="fsa_chat_input.php" method="post" id="messageForm">
