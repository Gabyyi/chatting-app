...
<html lang="en">
    <head>
        ...
        <script src="fils_messages.js" defer></script>
    </head>
<body>
    ...
    <div class="content">
        <div class="chats">
            <ul>
                ...
                <div class="open-chat">
                    <li><a href="fils_chat.php">FILS</a></li>
                </div>    
        ...
        <div id="chat-container" class="chat-container">
            ...
            <div class="chat-input">
                <form action="fils_chat_input.php" method="post" id="messageForm">
