...
<head>
    ...
    <script src="imm_messages.js" defer></script>
</head>
<body>
    ...
    <div class="content">
        <div class="chats">
            <ul>
                ...
                <li><a href="imm_chat.php">IMM</a></li>
        ...
        <div id="chat-container" class="chat-container">
            ...
            <div class="chat-input">
                <form action="imm_chat_input.php" method="post" id="messageForm">
