...
<head>
    ...
    <script src="faima_messages.js" defer></script>
</head>
<body>
    ...
    <div class="content">
        <div class="chats">
            <ul>
                ...
                <li><a href="faima_chat.php">FAIMA</a></li>
            </ul>
        </div>
        <div id="chat-container" class="chat-container">
            ...
            <div class="chat-input">
                <form action="faima_chat_input.php" method="post" id="messageForm">
